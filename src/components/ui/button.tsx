  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium font-body ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gold: "bg-gradient-to-r from-gold to-gold-dark text-purple-deep font-semibold hover:shadow-[0_0_40px_hsla(45,80%,55%,0.3)] hover:scale-105",
        magenta: "bg-gradient-to-r from-magenta to-secondary text-white font-semibold hover:shadow-[0_0_40px_hsla(320,70%,55%,0.4)] hover:scale-105",
        glass: "bg-white/10 border border-white/20 text-foreground hover:bg-white/20 backdrop-blur-xl",
      },
      size: {
